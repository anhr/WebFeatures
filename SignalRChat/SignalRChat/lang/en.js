...
var lang = {
    ...
    , helpContent: '<h1 style="text-align:center">Thank you for using our chat.</h1>'
        ...
        + '<ul>'
	        ...
	        + '<li class="help">You can open a private room with any visitor. Please click the selected visitor, open  the Private branch and press Enter button.</li>'
	        ...
	        + '<li class="help">You can format your message before sending to chat. Press △ button in right bottom corner of the page for this.</li>'
        + '</ul>'
