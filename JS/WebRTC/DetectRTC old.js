...
(function () {
    ...
    var arrCaptureStream = ['captureStream', 'mozCaptureStream', 'webkitCaptureStream'];
    //arrCaptureStream.forEach(function (item)//Andrej do not support in IE6
    for(var i = 0; i < arrCaptureStream.length; i++)
    {
        var item = arrCaptureStream[i];
    ...
    function checkDeviceSupport(callback) {
        ...
        navigator.enumerateDevices(function (devices) {
            ...
            devices.forEach(function (_device) {
                ...
                if (!device.label) {//for firefox 45.0 for Android
                    device.label = 'Device ' + deviceNumber;
                    deviceNumber++;
/*
...
*/
    ...
    var arrRTCPeerConnection = ['RTCPeerConnection', 'webkitRTCPeerConnection', 'mozRTCPeerConnection', 'RTCIceGatherer'];
    //['RTCPeerConnection', 'webkitRTCPeerConnection', 'mozRTCPeerConnection', 'RTCIceGatherer'].forEach(function (item)//Andrej do not support in IE6
    for(var i = 0; i < arrRTCPeerConnection.length; i++)
    {
        var item = arrRTCPeerConnection[i];
/*        
...
*/
    ...
    var arrAudioContext = ['AudioContext', 'webkitAudioContext', 'mozAudioContext', 'msAudioContext'];
    //['AudioContext', 'webkitAudioContext', 'mozAudioContext', 'msAudioContext'].forEach(function (item) {//Andrej do not support in IE6
    for(var i = 0; i < arrAudioContext.length; i++)
    {
        var item = arrAudioContext[i];
/*        
...
*/
    ...
    if (DetectRTC.browser.isFirefox /*&& DetectRTC.browser.version > 39*/) {
        ...
        if (typeof webkitRTCPeerConnection == 'undefined')//for LJ Chrome browser
            console.warn('webkitRTCPeerConnection id not defined');
        else {
